// Vendored, full-fidelity copy of shadcn/registry/tweakcn-themes.json's
// 42 themes (light+dark cssVars: colors, fonts, radius, shadows, tracking).
// Unlike token-generator/tweakcn-presets.js (a 6-role trim for the M3
// pipeline), this keeps every variable theme-editor's sidebar/toolbar need.
const tweakcnThemes = [
  {
    "name": "modern-minimal",
